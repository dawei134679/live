package com.midas.protocol.getBlance.pay;
...
public class PayReqData {
	...
	private Integer amt; //：扣游戏币数量，atn不能为0。
	...
	public Map<String,String> GetPayReqDataMap(String openid, String openkey, Integer appid,
			Long ts, String pf, String pfkey, String zoneid, Integer amt, String billno) {
		setAppid(appid);
		setOpenid(openid);
		setOpenkey(openkey);
		setPf(pf);
