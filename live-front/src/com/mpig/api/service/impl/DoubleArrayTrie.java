...
public class DoubleArrayTrie {
	...
	public int exactMatchSearch(String key, int pos, int len, int nodePos) throws NullPointerException{
		if (len <= 0)
			len = key.length();
		if (nodePos <= 0)
			nodePos = 0;
	...
	public String commonPrefixSearch(String key) {
		return commonPrefixSearch(key + " ", 0, 0, 0);
	}

	public String commonPrefixSearch(String key, int pos, int len,
			int nodePos) {
		if(base == null){
			return null;
		}
