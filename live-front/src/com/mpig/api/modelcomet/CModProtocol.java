...
//	public final static int live_quit = 29; 	//连麦退出
	...
	public final static int gameCarUserTotalStake = 401; //押注总额推送(押注游戏中使用)
	public final static int setRoomShowUserNum = 402; //设置房间显示人数
	public final static int robotSpeak = 403; //机器人说话
	
	public final static int pk_invite = 410; //PK邀请
	public final static int pk_invite_result = 411; //PK邀请结果
	public final static int pk_num_of_votes = 412; //投票数
	public final static int pk_result = 413; //PK结果
	public final static int pk_start = 414; //开始PK
	
	public final static int invite_close = 415; //结束连麦
