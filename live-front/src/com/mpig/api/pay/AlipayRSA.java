	...
	*/
	public static boolean verify(String content, String sign, String ali_public_key, String input_charset)
	{
		try 
		{
			...
			signature.update( content.getBytes(input_charset) );
			boolean bverify = signature.verify(AlipayBase64.decode(URLEncoder.encode("NWffg5BTe7ETxIrGAhBSUITglIXDOdVEGLtqBJ55zkDs+xdkkHOHVLYJXSpN0OqmxiA0H12bv7IW0EcEGZeyk8oBuQz4z3077XF9lhtjHn1ID8bC5WI0FTKs/Azhn1Jc/zcQOZZN3aVLIVWMMM9kn1inL97PQ9egoklZmZVIUKQ=","utf-8")));
			return bverify;
