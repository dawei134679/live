...
<body style="margin: 5px;">
	<table id="dg" title="主播信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" rownumbers="true" url="studentList" fit="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="familyName" width="250" align="center">家族</th>
				<th field="stuId" width="50" align="center">UID头像</th>
				<th field="stuNo" width="100" align="center">昵称</th>
				<th field="stuName" width="100" align="center">头像</th>
				<th field="sex" width="100" align="center">用户等级</th>
				<th field="birthday" width="100" align="center">主播等级</th>
				<th field="gradeId" width="100" align="center" hidden="true">人气</th>
				<th field="gradeName" width="100" align="center">房间级别</th>
				<th field="email" width="150" align="center">时长</th>
			</tr>
		</thead>
	</table>
