...
$(function () {
    dataGrid = $("#dg").datagrid({
		...
		sortOrder : 'desc',
        columns: [[
            {field: 'id', width:"200", title: '广告Id', align: 'center', sortable: false},
			...
			{field: 'swi', width:"200", title: '状态', align: 'center', sortable: false,formatter : function(data){
            ...
            {field: 'edit', width:"90", title: '操作', align: 'center', sortable: false,formatter : function(data) {
            	return '<a href="javascript:UpdateAdv();" class="easyui-tooltip" title="查看用戶信息">编辑</a>';
			}},
...
function saveAdv(){
	var arr = document.getElementsByName("switch");
...
function editAdv(){
    ...
    $('#fn').form('submit',{
    	url:'../bannerEdit?id='+row.id+'&swi='+swi,
        onSubmit: function(){
            return $(this).form('validate');
        },
        success: function(result){
...
<body style="margin: 5px;">
	...
	<div id="tb" style="padding: 2px 5px; height: auto">
		<div>
			<input type="button" value="创建开屏广告" onclick="createAdv()">
		</div>
	</div>
	...
	<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post">
				<table cellspacing="5px;">
					...
					<tr>
						<td>开始时间</td>
						<td>
							<input class="easyui-datetimebox" name="StartDate" id="StartDate" style="width:150px;height:24px">
						</td>
						<td>结束时间</td>
						<td>
							<input class="easyui-datetimebox" name="EndDate" id="EndDate" style="width:150px;height:24px">
						</td>
					</tr>
					<div>
						<input type="radio" name="switch" value="0">不显示&nbsp;&nbsp;&nbsp;&nbsp;
						<input type="radio" name="switch" value="1">显示&nbsp;&nbsp;&nbsp;&nbsp;
					</div>
					<div id="preview">
		...
		<div id="edit-buttons">
			<a href="javascript:editAdv()" class="easyui-linkbutton"
				iconCls="icon-ok">保存</a> <a href="javascript:editout()"
				class="easyui-linkbutton" iconCls="icon-cancel">关闭</a>
		</div>
</body>
</html>