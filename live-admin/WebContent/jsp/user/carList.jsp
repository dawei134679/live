...
<script>
	...
	$(function() {
		...
		dataGrid = $("#carlist").datagrid(
				{
					url : '../../gift/getUsedCarList',
					width : getWidth(0.97),
...
<body style="margin: 5px;">
		...
		<div id="tb" style="padding: 2px 5px; height: auto">
			<div>
				<a href="javascript:addCarDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">新增</a>
			</div>
			<div>
					...
					<tr>
						...
						<td>
							...
							data-options="valueField: 'gid',
    									textField: 'gname',
    									url: '../../gift/forSelectBySubtype?subtype=5'"
    						/>
						</td>
					</tr>
					<tr>
