...
<body>
	...
	<script type="text/javascript">
		...
		function get_monitor_list(){
			$.get('../monitor?method=monitor&recommend=1',function(data){
		...
		function play_video(id){
			...
			/* var videourl = "http://pili-live-hls.wezhibo.com.cn/wezb/"+id+".m3u8"; */
			var iframe = "<iframe src='ckPlayer.jsp?videourl="+videourl+"' style='border-width: 0px;width: 560px;height: 610px'></iframe>";
			 $('#dlg').html(iframe);
			$("#dlg").dialog("open").dialog('center').dialog("setTitle", "最新主播监控");
		}
