...
<script>
	...
	function listToExcel(){
		var url = "../../operat/listToExcel?searchos="+$("#searchos").combobox("getValue")+"&channel="+$("#channel").combobox("getValue")+"&platform="+$("#platform").textbox("getValue")+"&startDate"+$("#startdate").textbox('getValue')+"&endDate="+$("#startdate").textbox('getValue')+"&category="+$("#category").combobox("getValue")+"&type=3";
