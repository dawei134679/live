...
<script type="text/javascript">
	...
	function allow(){
		...
		$.ajax({
                ...
                data: {id:row.id,uid:row.anchorid,picCover:row.picCover,picCover1:row.picCover1,picCover2:row.picCover2},		//参数列表：主播编号、封面地址、4:3封面地址、16:9封面地址
