...
public class ExcelUtil {
	 ...
	 * @throws IOException
	 */
	public boolean export2File(ExcelExportData setInfo, String outputExcelFileName) throws Exception {
	 ...
	 * @throws Exception
	 */
	public byte[] export2ByteArray(ExcelExportData setInfo) throws Exception {
	 ...
	 * @throws Exception
	 */
	public HSSFWorkbook export2WorkBook(ExcelExportData setInfo) throws Exception {
		export2Stream(setInfo);
		return wb;
	}
	 ...
	 * @throws Exception
	 */
	public ByteArrayOutputStream export2Stream(ExcelExportData setInfo) throws Exception {
			...
			for (Object obj : objs) {
				...
				if (fieldNames != null) {
					for (int num = 0; num < fieldNames.length; num++) {
						Object value = null;
						String key = fieldNames[num];
						if(obj instanceof HashMap) {
							value = ((HashMap)obj).get(key);
						} else {
							value = ReflectionUtil.invokeGetterMethod(obj, key); 
						}
	 ...
	 */
	private void createTableTitleRow(ExcelExportData setInfo, HSSFSheet[] sheets, int sheetNum) {
	 ...
	 */
	private void createTableDateRow(ExcelExportData setInfo, HSSFSheet[] sheets, int sheetNum) {
	 ...
	 */
	private void creatTableHeadRow(ExcelExportData setInfo, HSSFSheet[] sheets, int sheetNum) {
		// 表头
